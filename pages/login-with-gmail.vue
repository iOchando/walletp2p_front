<template>
  <div id="login-with-gmail" class="divcol center">
    ...
    <section id="login-with-gmail-content">
      <!-- accounts button -->
      <v-btn
        v-for="(item, i) in accounts" :key="i"
        class="account btn-outlined mb-5"
      >
      ...
      <!-- another button -->
      <v-btn class="account btn-outlined">
        <div class="d-flex align-center" style="gap: 8px;">
          <v-img
            :src="require('@/assets/sources/icons/account-icon.svg')"
            alt="account icon"
            max-width="27"
            width="27"
            height="27"
...
<style src="~/assets/styles/pages/login-with-gmail.scss" lang="scss" />
